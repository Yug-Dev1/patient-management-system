...
public class AdminUpdateInventory extends javax.swing.JFrame {
    private Admin_Inventory parent;   // Reference to main screen
    private int itemId;  
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(AdminUpdateInventory.class.getName());

    public AdminUpdateInventory(Admin_Inventory parent, int itemId) {
        initComponents();
        this.parent = parent;
        this.itemId = itemId;
...
Integer itemId = getItemId();
 ...
 Integer itemId = getItemId();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> new AdminUpdateInventory().setVisible(true));
    }
