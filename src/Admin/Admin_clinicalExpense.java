...
public class Admin_clinicalExpense extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Admin_clinicalExpense.class.getName());

    public Admin_clinicalExpense() {
        initComponents();
        loadtbl();
        adjustColumnWidths();
        addPlaceholder(txtSearch,"Search (Category / Description)");
    ...
    public void loadtbl(){
        ...
        String sql = "SELECT category, description, amount, payment_mode, expense_date, created_at" +
        " FROM clinic_expense_tracker ";
   ...
   private void addPlaceholder(javax.swing.JTextField field, String placeholderText) {
    ...
    private void initComponents() {
        ...
        lblHeaderNm.setText("Clinical Expense");
        ...
        tblPatients.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "category", "Description", "Amount", "Payment mode", "Date", "CreateDate"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Admin_clinicalExpense().setVisible(true));
    }
