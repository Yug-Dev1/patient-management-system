...
import Reception.PatientDetailsForm1;
...
public class Admin_patient extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Admin_patient.class.getName());
...
private void openSelectedPatient() {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Admin_patient().setVisible(true));
    }
