...
public class Admin_Inventory extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Admin_Inventory.class.getName());
 ...
 styleHoverButton(jButton3);
    ...
    // open popup
    AdminUpdateInventory edit = new AdminUpdateInventory(this, itemId);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        AdminAddInventory add = new AdminAddInventory(this);
        add.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Admin_Inventory().setVisible(true));
    }
