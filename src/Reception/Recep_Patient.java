...
import Doctor.PatientDetailsForm;
...
public class Recep_Patient extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Recep_Patient.class.getName());
    private int userId;
    private String userName;
public Recep_Patient(int userId, String name) {
         initComponents();
        this.userId = userId;
        this.userName = name;
        setLocationRelativeTo(null);
        setResizable(false);
        lblHeaderNm.setText("Welcome " + name);  // 👈 now lblHeaderNm is NOT null
...
private void openSelectedPatient() {
    ...
    PatientDetailsForm1 detail = new PatientDetailsForm1(patientId);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        AddNew_Patient rp = new AddNew_Patient(userId, userName);
