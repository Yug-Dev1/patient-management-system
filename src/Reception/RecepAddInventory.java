...
public class RecepAddInventory extends javax.swing.JFrame {
    private Recep_Inventory parent;   // Reference to main screen
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(RecepAddInventory.class.getName());

    private Recep_Inventory parentReference;
    public RecepAddInventory(Recep_Inventory parent) {
        initComponents();
